...
/*   Updated: 2025/02/21 15:20:29 by ktieu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_map_player(t_cub *c, t_asset_manager *am)
{
	...
	map_org = am->map->pixels;
	m_player_org = am->m_player->pixels;
	...
	am->map->pixels = ft_get_pixels(
			am->map, c->player.current.x, c->player.current.y);
